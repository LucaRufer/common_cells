...
add wave -position end  sim:/dmr_stream_fork_tb/i_dut/data_q
add wave -position end  sim:/dmr_stream_fork_tb/i_dut/state_q
add wave -position end  sim:/dmr_stream_fork_tb/i_dut/repeat_q
add wave -position end  sim:/dmr_stream_fork_tb/i_dut/latch_data
add wave -position end  sim:/dmr_stream_fork_tb/i_dut/bypass
